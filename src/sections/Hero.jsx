  ...
  return (
    <section id='home'
      ...
      <div className="relative xl:w-2/5 flex flex-col justify-center items-start w-full max-xl:padding-x pt-28">
        <p className="text-xl placeholder:font-montserrat text-coral-red">Our Summer Collection</p>
          ...
          {statistics.map((stat) => {
            return (
              <div key={stat.label}>
                ...
                <p className="text-slate-gray font-palanquin leading-7">{stat.label}</p>
              </div>
            )
